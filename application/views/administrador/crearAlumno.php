...
<div class="container">
  ...
  <form action="#" id="guardarAlumno">
    ...
    <div class="row">
      <div class="col">
        <input type="text" class="form-control" id="app_paterno" placeholder="Apellido paterno" name="appaterno" required>
      </div>
      <div class="col">
    ...
    <div class="row">
      ...
      <div class="col">
        <input type="cursando" class="form-control" id="cursando" placeholder="Cursando" name="cursando" required>
      </div>
    </div>
