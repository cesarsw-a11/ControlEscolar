...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-4 order-md-2 mb-4">
            ...
            <iframe width="330" height="280" src="https://www.youtube.com/embed/fLkCsqgE1_g"
                title="YouTube video player" frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                allowfullscreen></iframe>
            <p class="text-justify">¿Qué nos definen?
                Nuestra modalidad de la secundaria técnica nos permite ofrecer, en la presecialidad una educación
                diferente de calidad e integral.
                Horarios de 6:55 a.m. a 2:10 p.m. con tecnologías de 8 módulos a la semana con especialidades en
                informática, agricultura y ganadería.
 ...
 -->            <form>
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="firstName" placeholder=""
                            value="<?= $alumno->emergencia ?>" disabled>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="lastName">Tecnologías:</label>
                        <input type="text" class="form-control" id="lastName" placeholder=""
                            value="<?= $alumno->tecnologias ?>" disabled>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="firstName" placeholder=""
                            value="<?= $alumno->inasistencias ?>" disabled>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="lastName">Conducta:</label>
                        <input type="text" class="form-control" id="lastName" placeholder=""
                            value="<?= $alumno->conducta ?>" disabled>
                    </div>
                </div>
                <div class="row">
